namespace LastGround.Core.Net.Protocol
{
    public static class NetProtocol
    {
        ...
        public const uint Version = 8; // 2: ZombieDeath batches (M3); 3: player flags, hit claims, vitals (M4); 4: M5 loop; 5: M6 combat content; 6: M7 events + interactables; 7: M8 boss, extraction, horde summary, reward conversion; 8: M9 meta selection, emotes
